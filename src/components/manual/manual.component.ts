...
@Component({
  ...
  template: `
    <div class="h-[100dvh] bg-[#050505] text-[#2a2320] font-serif flex flex-col relative overflow-hidden">
      ...
      <!-- Header -->
      <header class="relative z-10 bg-[#1a0b06] border-b-4 border-[#E86C26] px-6 py-4 flex justify-between items-center shadow-lg shrink-0 safe-area-pt safe-area-pr safe-area-pl">
        <div class="flex items-center gap-4">
           <a routerLink="/dashboard" class="text-[#EAE0D5] hover:text-[#E86C26] transition-colors uppercase font-bold text-xs tracking-widest flex items-center gap-2">
             <span class="text-xl">←</span> Voltar ao Painel
           </a>
        </div>
        <h1 class="text-[#E86C26] font-black uppercase tracking-[0.2em] text-lg md:text-xl hidden md:block">
          Protocolo Inteligente V9.9
        </h1>
      </header>

 ...
 */
export function freezeStateMetaReducer(reducer: ActionReducer<AppState>): ActionReducer<AppState> {
  return (state, action) => {
...
export const metaReducers: MetaReducer<any>[] = [freezeStateMetaReducer];
